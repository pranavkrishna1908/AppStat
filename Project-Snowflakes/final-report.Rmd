...
$$
where $\widehat{\lambda}$ is a specific estimator consistent under $H_0$.
...
* **for** $b=1,\ldots,B$ 
  ...
  - set $T_b^\star = \sup_x \Big| \widehat{F}_\widehat{\lambda}_b^\star - F_{\widehat{\lambda}_b^\star}(x) \Big|$
