...
We observe that the p-value is quite large(0.71) and thus, we can say confidently that the model is able to adequately capture the underlying patterns in the data and the inference that Covid reduced the Home advantage in valid. This is in spite of our assumption that the scores in each match are independent realisations of Poisson Random Variables.
