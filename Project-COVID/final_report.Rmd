...
The data we have is regarding the daily number of covid cases in USA by state. We decide to threshold at 2 Deaths in each state to declare the start of the pandemic and look at the next 60 days and study the evolution. 
...
data_prepared = t(logged_cmulative)#states are rows now
