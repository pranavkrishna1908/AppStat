...
ggplot()+
  geom_point(aes(x = Data$exit_rates, y = Data$page_values), col = ifelse(Data$purchase, 'red', 'blue' ))
...
Data %>%
mutate(res=resid(gm0),operating_systems=as.numeric(operating_systems), month = as.numeric(month), browser=as.numeric(browser), region = as.numeric(region),  visitor_type = as.numeric(visitor_type),
